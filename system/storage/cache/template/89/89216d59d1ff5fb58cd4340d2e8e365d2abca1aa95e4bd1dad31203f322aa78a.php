...
class __TwigTemplate_832c5041f508faf0257ab347346dc41c20d899c8ae3ff05018cb1f2494e034fe extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t
\t\t\t\t\t</div>
\t\t\t\t\t<a href=\"#callform\" class=\"brn-callback\">Заказать звонок</a>
\t\t\t\t</div>
\t\t\t\t<div class=\"right-man\">
