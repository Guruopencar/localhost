...
class __TwigTemplate_cdf797db05cd87d5529702e3bc2dca1be1a8e27ecf7634f06d89f5a81ed57063 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t</div>\t
\t\t\t<div class=\"header\">
\t\t\t\t<div class=\"left-header\"><img src=\"image/logo.png\" alt=\"\" title=\"\" /></div>
...
\t\t\t\t\t<div class=\"subtitle-preferens\">Натуральные компоненты</div>
\t\t\t\t\t
\t\t\t\t</div>
\t\t\t\t<div class=\"item-preferens\">
